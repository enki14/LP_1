<div id="question" class="aco-eria bg-white">
    <div class="aco_wrapper">
        <h2 class="text-center my-5 mx-0">
            <img src="<?php echo esc_url(get_template_directory_uri() .'/images/pc/l-faq_ttl_sp.png') ?>" alt="よくあるご質問" />
        </h2>
            ...
            <div class="d-flex justify-content-center">
                <div class="row">
                    ...
                    class="twitter col-6" rel="nofollow" target="_blank">
                        <img src="<?php echo esc_url(get_template_directory_uri() .'/images/pc/l-sns_icn_01_pc.png') ?>" 
                        alt="twitter" />
                    </a>
                    <a href="https://line.me/R/ti/p/%40156hwqfo" 
                    class="line_button col-6" rel="nofollow" target="_blank">
                        <img src="<?php echo esc_url(get_template_directory_uri() .'/images/pc/l-sns_icn_02_pc.png') ?>" 
                        alt="line"  />
                    </a>
                </div>
            </div>
